            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    <div class="link-title">
                        <h4>Business</h4>
                        <ul class="links">
                            <li><a href="{{route('shop.partner')}}">Add a shop</a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    <div class="link-title">
                        ...
                        <ul class="links">
                            <li><a href="{{route('shop.partner')}}">For Shop</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <i class="far fa-copyright"></i>Copyright {{date('Y')}} <a href="{{url('/')}}">Dokanamar</a>. All Rights Reserved.
                        </div>
                    </div>
                </div>
            </div>
