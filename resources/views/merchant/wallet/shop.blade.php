@extends('layouts.app')
@section('title','Shops Credit Withdraw List')
@section('style')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">Dashboard</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Shop's Credit Withdraw List</span>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">USER'S CREDIT WITHDRAW LIST</h4>
                        </div>
                    </div>
                    <div class="card-body">
...
@section('script')
    ...
    <script type="text/javascript">
        $(".yesConfirmation").click(function () {
            ...
            var confirmFunction="{{url('admin/shop/wallet/approve/')}}/" + id;
            swal({
                title:'Are you sure?',
