                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('size') ? ' is-invalid' : '' }}" name="size" value="{{ isset($property) ? $property->size : '' }}"  placeholder="125 x 125">
                                        @if($errors->has('size'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('bed') ? ' is-invalid' : '' }}" name="bed" value="{{ isset($property) ? $property->bed : '' }}"  placeholder="Beds">
                                        @if($errors->has('bed'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('washroom') ? ' is-invalid' : '' }}" name="washroom" value="{{ isset($property) ? $property->washroom : '' }}"  placeholder="Washrooms">
