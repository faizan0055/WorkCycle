            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    ...
                    <div class="card-body pt-0">
                        <form class="form-horizontal needs-validation" method="post" action="{{ isset($consult) ? route('consults.update',$consult->id) : route('consults.store') }}" enctype="multipart/form-data">
                            @csrf
                            @if (isset($consult))
                                @method('PUT')
                            @endif
