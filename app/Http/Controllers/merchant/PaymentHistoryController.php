...
class PaymentHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('client.payment_history.index',compact('Total_Earning','this_week_earning','today_earning'));
    }
    ...
    public function create()
    {
        ...
        $this_week_earning = DB::table('orders')->where('restaurant_id',$restaurant_id)->where('created_at','>', Now()->day-7)->sum('total');
        //dd($this_week_earning);
        return view('client.payment_history.history',compact('Total_Earning','this_week_earning','today_earning'));
    }
